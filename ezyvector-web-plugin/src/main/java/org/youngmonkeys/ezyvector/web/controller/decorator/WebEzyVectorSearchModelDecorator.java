...
@EzySingleton
@AllArgsConstructor
public class WebEzyVectorSearchModelDecorator {

    private final WebEzyVectorModelToResponseConverter modelToResponseConverter;

    public WebEzyVectorSearchResponse decorateToSearchResponse(
        List<EzyVectorSearchResultModel> results
    ) {
        return modelToResponseConverter.toSearchResponse(results);
    }
}
