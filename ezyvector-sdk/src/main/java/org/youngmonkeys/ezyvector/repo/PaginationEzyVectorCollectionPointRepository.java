...
public class PaginationEzyVectorCollectionPointRepository extends CommonPaginationRepository<
    ...
    @Override
    protected Class<EzyVectorCollectionPoint> getEntityType() {
        return EzyVectorCollectionPoint.class;
    }
}
