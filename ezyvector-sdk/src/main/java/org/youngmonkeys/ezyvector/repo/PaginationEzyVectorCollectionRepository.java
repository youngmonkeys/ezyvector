...
public class PaginationEzyVectorCollectionRepository extends CommonPaginationRepository<
    ...
    @Override
    protected Class<EzyVectorCollection> getEntityType() {
        return EzyVectorCollection.class;
    }
}
