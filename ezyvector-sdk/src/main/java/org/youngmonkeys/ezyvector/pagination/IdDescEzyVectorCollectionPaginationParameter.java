...
@NoArgsConstructor
@AllArgsConstructor
public class IdDescEzyVectorCollectionPaginationParameter
    implements EzyVectorCollectionPaginationParameter {
    ...
    public String sortOrder() {
        return EzyVectorCollectionPaginationSortOrder
            .ID_DESC
            .toString();
    }
}
